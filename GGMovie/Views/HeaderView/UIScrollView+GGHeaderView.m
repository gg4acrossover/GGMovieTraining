...
@property (nonatomic, readwrite) GGHeaderViewState mState;
...
{
    // do not want to track when the parallax view is hidden
    if (contentOffset.y > 0)
    {
        self.mState = GGHeaderViewStateInActive;
    }
    else
    {
        self.mState = GGHeaderViewStateActive;
    }
    
    if(self.mState == GGHeaderViewStateActive)
    {
